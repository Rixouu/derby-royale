  ...
  en: {
    ...
    lobby: {
      ...
      help: {
        ...
        cta: "LET'S RACE!",
        bodyHTML: '<div class="help-layout help-layout-portrait help-layout-illustrated"><div class="help-stage"><img class="help-stage-img" src="/elements/img-group-racers-standing.png" alt=""></div><div class="help-step-card"><div class="help-step-side"><span class="help-step-badge help-step-badge-square">1</span><div class="help-step-copy"><div class="help-step-title">Pick your racers</div><div class="help-step-desc">Choose up to 6 champions<br>and give them epic names!</div></div></div><div class="help-step-visual"><img class="help-step-asset help-step-asset-racers" src="/elements/img-racers-pick.png" alt=""></div></div><div class="help-step-card"><div class="help-step-side"><span class="help-step-badge help-step-badge-square">2</span><div class="help-step-copy"><div class="help-step-title">Set up the race</div><div class="help-step-desc">Choose a scene, race length<br>and power-ups to build<br>your challenge.</div></div></div><div class="help-step-visual help-step-visual-scene"><img class="help-step-asset help-step-asset-scene" src="/elements/img-scene.png" alt=""></div></div><div class="help-step-card"><div class="help-step-side"><span class="help-step-badge help-step-badge-square">3</span><div class="help-step-copy"><div class="help-step-title">Watch the race</div><div class="help-step-desc">Cheer your racer to victory<br>and enjoy the chaos!</div></div></div><div class="help-step-visual"><img class="help-step-asset help-step-asset-run" src="/elements/img-group-racers-run.png" alt=""></div></div></div><div class="help-layout help-layout-landscape"><div class="help-land-card help-land-card-pick"><div class="help-land-head"><span class="help-step-badge help-step-badge-square">1</span><div class="help-step-copy"><div class="help-step-title">Pick your racers</div><div class="help-step-desc">Choose up to 6 champions<br>and give them epic names!</div></div></div><div class="help-land-visual help-land-visual-pick"><img class="help-step-asset help-step-asset-racers" src="/elements/img-racers-pick.png" alt=""></div></div><div class="help-land-card help-land-card-setup"><div class="help-land-head"><span class="help-step-badge help-step-badge-square">2</span><div class="help-step-copy"><div class="help-step-title">Set up the race</div><div class="help-step-desc">Choose a scene, race length<br>and power-ups to build<br>your challenge.</div></div></div><div class="help-land-visual help-land-visual-scene"><img class="help-step-asset help-step-asset-scene" src="/elements/img-scene.png" alt=""></div></div><div class="help-land-card help-land-card-watch"><div class="help-land-head"><span class="help-step-badge help-step-badge-square">3</span><div class="help-step-copy"><div class="help-step-title">Watch the race</div><div class="help-step-desc">Cheer your racer to victory<br>and enjoy the chaos!</div></div></div><div class="help-land-visual help-land-visual-run"><img class="help-step-asset help-step-asset-run" src="/elements/img-group-racers-run.png" alt=""></div></div></div>',
      },
      rules: {
        title: 'Rules',
        hint: 'Know the game',
        bodyHTML: `<div class="rules-layout rules-layout-portrait"><div class="rules-banner"><img class="rules-banner-icon" src="/elements/icon-beer.png" alt=""><div class="rules-banner-copy">These are the drinking rules.<br>Play fair, have fun and<br>drink responsibly!</div></div><div class="rules-list"><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon rules-row-icon-trophy" src="/elements/icon-trophy.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">The goal</div><div class="rules-row-desc">Be the first racer to cross<br>the finish line.<br>Everyone else drinks.</div></div></div></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon" src="/elements/icon-medals-2nd-place.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Winner</div><div class="rules-row-desc">Winner = number of players<br>in drinks.<br>You decide who drinks!</div></div></div><img class="rules-row-visual rules-row-visual-podium" src="/elements/img-podium.png" alt=""></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon" src="/elements/icon-medals-3rd-place.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Everyone else</div><div class="rules-row-desc">Drink your finishing position.<br>2nd = 2 drinks<br>3rd = 3 drinks<br>... and so on.</div></div></div><img class="rules-row-visual rules-row-visual-places" src="/elements/img-racers.png" alt=""></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon rules-row-icon-snail" src="/elements/img-snail.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Slowpoke clause</div><div class="rules-row-desc">Never led the race<br>(not even for a second)?<br><span class="rules-accent">+1 drink of shame.</span></div></div></div><img class="rules-row-visual rules-row-visual-slowpoke" src="/elements/img-slow-poke.png" alt=""></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon rules-row-icon-flags" src="/elements/icon-flags.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Ties</div><div class="rules-row-desc">Racers tied at the finish?<br>Run it back!<br>Highest place after restart wins.</div></div></div><img class="rules-row-visual rules-row-visual-tie" src="/elements/img-tie.png" alt=""></div></div><div class="rules-powerups"><div class="rules-powerups-title">Power-ups</div><div class="rules-power-grid"><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-speed.png" alt=""><div class="rules-power-name">Boost</div><div class="rules-power-desc">Burst<br>of speed</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-stars.png" alt=""><div class="rules-power-name">Star</div><div class="rules-power-desc">Speed +<br>immunity</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-banana.png" alt=""><div class="rules-power-name">Banana</div><div class="rules-power-desc">Drop a<br>trap</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-slow.png" alt=""><div class="rules-power-name">Lightning</div><div class="rules-power-desc">Slow<br>others</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-shield.png" alt=""><div class="rules-power-name">Shield</div><div class="rules-power-desc">Block one<br>hit</div></div></div></div></div><div class="rules-layout rules-layout-landscape"><div class="rules-summary"><div class="rules-summary-grid"><div class="rules-summary-card rules-summary-card-intro"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-beer" src="/elements/icon-beer.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-desc">These are the drinking rules.<br>Play fair, have fun and<br>drink responsibly!</div></div></div></div><div class="rules-summary-card rules-summary-card-goal"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-trophy" src="/elements/icon-trophy.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">The goal</div><div class="rules-summary-desc">Be the first racer<br>to cross the finish line.<br>Everyone else drinks.</div></div></div></div><div class="rules-summary-card rules-summary-card-winner"><div class="rules-summary-main"><img class="rules-summary-icon" src="/elements/icon-medals-2nd-place.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Winner</div><div class="rules-summary-desc">Winner = number of<br>players in drinks.<br>You decide who drinks!</div></div></div><img class="rules-summary-visual rules-summary-visual-podium" src="/elements/img-podium.png" alt=""></div><div class="rules-summary-card rules-summary-card-everyone"><div class="rules-summary-main"><img class="rules-summary-icon" src="/elements/icon-medals-3rd-place.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Everyone else</div><div class="rules-summary-desc">Drink your finishing position.<br>2nd = 2 drinks<br>3rd = 3 drinks<br>... and so on.</div></div></div><img class="rules-summary-visual rules-summary-visual-places" src="/elements/img-racers.png" alt=""></div><div class="rules-summary-card rules-summary-card-slowpoke"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-snail" src="/elements/img-snail.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Slowpoke clause</div><div class="rules-summary-desc">Never led the race<br>(not even for a second)?<br><span class="rules-accent">+1 drink of shame.</span></div></div></div><img class="rules-summary-visual rules-summary-visual-slowpoke" src="/elements/img-slow-poke.png" alt=""></div><div class="rules-summary-card rules-summary-card-ties"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-flags" src="/elements/icon-flags.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Ties</div><div class="rules-summary-desc">Racers tied at the finish?<br>Run it back!<br>Highest place after restart wins.</div></div></div><img class="rules-summary-visual rules-summary-visual-tie" src="/elements/img-tie.png" alt=""></div></div></div><div class="rules-powerups"><div class="rules-powerups-title">Power-ups</div><div class="rules-power-grid"><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-speed.png" alt=""><div class="rules-power-name">Boost</div><div class="rules-power-desc">Burst<br>of speed</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-stars.png" alt=""><div class="rules-power-name">Star</div><div class="rules-power-desc">Speed +<br>immunity</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-banana.png" alt=""><div class="rules-power-name">Banana</div><div class="rules-power-desc">Drop a<br>trap</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-slow.png" alt=""><div class="rules-power-name">Lightning</div><div class="rules-power-desc">Slow<br>others</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-shield.png" alt=""><div class="rules-power-name">Shield</div><div class="rules-power-desc">Block one<br>hit</div></div></div></div></div>`,
      },
  ...
  fr: {
    ...
    lobby: {
      ...
      help: {
        ...
        hint: 'En 30 secondes',
        cta: 'C EST PARTI !',
        bodyHTML: '<div class="help-layout help-layout-portrait help-layout-illustrated"><div class="help-stage"><img class="help-stage-img" src="/elements/img-group-racers-standing.png" alt=""></div><div class="help-step-card"><div class="help-step-side"><span class="help-step-badge help-step-badge-square">1</span><div class="help-step-copy"><div class="help-step-title">Choisissez vos coureurs</div><div class="help-step-desc">Prenez jusqua 6 champions<br>et donnez-leur des noms cultes !</div></div></div><div class="help-step-visual"><img class="help-step-asset help-step-asset-racers" src="/elements/img-racers-pick.png" alt=""></div></div><div class="help-step-card"><div class="help-step-side"><span class="help-step-badge help-step-badge-square">2</span><div class="help-step-copy"><div class="help-step-title">Reglez la course</div><div class="help-step-desc">Choisissez scene, longueur<br>et power-ups pour creer<br>votre defi.</div></div></div><div class="help-step-visual help-step-visual-scene"><img class="help-step-asset help-step-asset-scene" src="/elements/img-scene.png" alt=""></div></div><div class="help-step-card"><div class="help-step-side"><span class="help-step-badge help-step-badge-square">3</span><div class="help-step-copy"><div class="help-step-title">Regardez la course</div><div class="help-step-desc">Encouragez votre coureur<br>et profitez du chaos !</div></div></div><div class="help-step-visual"><img class="help-step-asset help-step-asset-run" src="/elements/img-group-racers-run.png" alt=""></div></div></div><div class="help-layout help-layout-landscape"><div class="help-land-card help-land-card-pick"><div class="help-land-head"><span class="help-step-badge help-step-badge-square">1</span><div class="help-step-copy"><div class="help-step-title">Choisissez vos coureurs</div><div class="help-step-desc">Prenez jusqua 6 champions<br>et donnez-leur des noms cultes !</div></div></div><div class="help-land-visual help-land-visual-pick"><img class="help-step-asset help-step-asset-racers" src="/elements/img-racers-pick.png" alt=""></div></div><div class="help-land-card help-land-card-setup"><div class="help-land-head"><span class="help-step-badge help-step-badge-square">2</span><div class="help-step-copy"><div class="help-step-title">Reglez la course</div><div class="help-step-desc">Choisissez scene, longueur<br>et power-ups pour creer<br>votre defi.</div></div></div><div class="help-land-visual help-land-visual-scene"><img class="help-step-asset help-step-asset-scene" src="/elements/img-scene.png" alt=""></div></div><div class="help-land-card help-land-card-watch"><div class="help-land-head"><span class="help-step-badge help-step-badge-square">3</span><div class="help-step-copy"><div class="help-step-title">Regardez la course</div><div class="help-step-desc">Encouragez votre coureur<br>et profitez du chaos !</div></div></div><div class="help-land-visual help-land-visual-run"><img class="help-step-asset help-step-asset-run" src="/elements/img-group-racers-run.png" alt=""></div></div></div>',
      },
      rules: {
        title: 'Regles',
        hint: 'Connaitre le jeu',
        bodyHTML: `<div class="rules-layout rules-layout-portrait"><div class="rules-banner"><img class="rules-banner-icon" src="/elements/icon-beer.png" alt=""><div class="rules-banner-copy">Voici les regles a boire.<br>Jouez fair-play, amusez-vous et<br>buvez avec moderation !</div></div><div class="rules-list"><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon rules-row-icon-trophy" src="/elements/icon-trophy.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Le but</div><div class="rules-row-desc">Passez la ligne en premier.<br>Tous les autres boivent.</div></div></div></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon" src="/elements/icon-medals-2nd-place.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Gagnant</div><div class="rules-row-desc">Le gagnant distribue autant<br>de gorgees qu il y a de joueurs.<br>Il choisit qui boit !</div></div></div><img class="rules-row-visual rules-row-visual-podium" src="/elements/img-podium.png" alt=""></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon" src="/elements/icon-medals-3rd-place.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Tous les autres</div><div class="rules-row-desc">Buvez votre place d arrivee.<br>2e = 2 gorgees<br>3e = 3 gorgees<br>... et ainsi de suite.</div></div></div><img class="rules-row-visual rules-row-visual-places" src="/elements/img-racers.png" alt=""></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon rules-row-icon-snail" src="/elements/img-snail.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Clause tortue</div><div class="rules-row-desc">Jamais en tete<br>(pas meme une seconde) ?<br><span class="rules-accent">+1 gorgee de honte.</span></div></div></div><img class="rules-row-visual rules-row-visual-slowpoke" src="/elements/img-slow-poke.png" alt=""></div><div class="rules-row"><div class="rules-row-side"><img class="rules-row-icon rules-row-icon-flags" src="/elements/icon-flags.png" alt=""><div class="rules-row-copy"><div class="rules-row-title">Egalites</div><div class="rules-row-desc">Egalite sur la ligne ?<br>Relancez la course !<br>Le mieux place apres restart gagne.</div></div></div><img class="rules-row-visual rules-row-visual-tie" src="/elements/img-tie.png" alt=""></div></div><div class="rules-powerups"><div class="rules-powerups-title">Power-ups</div><div class="rules-power-grid"><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-speed.png" alt=""><div class="rules-power-name">Boost</div><div class="rules-power-desc">Burst<br>de vitesse</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-stars.png" alt=""><div class="rules-power-name">Etoile</div><div class="rules-power-desc">Vitesse +<br>immunite</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-banana.png" alt=""><div class="rules-power-name">Banane</div><div class="rules-power-desc">Pose un<br>piege</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-slow.png" alt=""><div class="rules-power-name">Eclair</div><div class="rules-power-desc">Ralentit<br>les autres</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-shield.png" alt=""><div class="rules-power-name">Bouclier</div><div class="rules-power-desc">Bloque<br>un coup</div></div></div></div></div><div class="rules-layout rules-layout-landscape"><div class="rules-summary"><div class="rules-summary-grid"><div class="rules-summary-card rules-summary-card-intro"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-beer" src="/elements/icon-beer.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-desc">Voici les regles a boire.<br>Jouez fair-play, amusez-vous et<br>buvez avec moderation !</div></div></div></div><div class="rules-summary-card rules-summary-card-goal"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-trophy" src="/elements/icon-trophy.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Le but</div><div class="rules-summary-desc">Passez la ligne en premier.<br>Tous les autres boivent.</div></div></div></div><div class="rules-summary-card rules-summary-card-winner"><div class="rules-summary-main"><img class="rules-summary-icon" src="/elements/icon-medals-2nd-place.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Gagnant</div><div class="rules-summary-desc">Le gagnant distribue autant<br>de gorgees qu il y a de joueurs.<br>Il choisit qui boit !</div></div></div><img class="rules-summary-visual rules-summary-visual-podium" src="/elements/img-podium.png" alt=""></div><div class="rules-summary-card rules-summary-card-everyone"><div class="rules-summary-main"><img class="rules-summary-icon" src="/elements/icon-medals-3rd-place.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Tous les autres</div><div class="rules-summary-desc">Buvez votre place d arrivee.<br>2e = 2 gorgees<br>3e = 3 gorgees<br>... et ainsi de suite.</div></div></div><img class="rules-summary-visual rules-summary-visual-places" src="/elements/img-racers.png" alt=""></div><div class="rules-summary-card rules-summary-card-slowpoke"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-snail" src="/elements/img-snail.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Clause tortue</div><div class="rules-summary-desc">Jamais en tete<br>(pas meme une seconde) ?<br><span class="rules-accent">+1 gorgee de honte.</span></div></div></div><img class="rules-summary-visual rules-summary-visual-slowpoke" src="/elements/img-slow-poke.png" alt=""></div><div class="rules-summary-card rules-summary-card-ties"><div class="rules-summary-main"><img class="rules-summary-icon rules-summary-icon-flags" src="/elements/icon-flags.png" alt=""><div class="rules-summary-copy"><div class="rules-summary-title">Egalites</div><div class="rules-summary-desc">Egalite sur la ligne ?<br>Relancez la course !<br>Le mieux place apres restart gagne.</div></div></div><img class="rules-summary-visual rules-summary-visual-tie" src="/elements/img-tie.png" alt=""></div></div></div><div class="rules-powerups"><div class="rules-powerups-title">Power-ups</div><div class="rules-power-grid"><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-speed.png" alt=""><div class="rules-power-name">Boost</div><div class="rules-power-desc">Burst<br>de vitesse</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-stars.png" alt=""><div class="rules-power-name">Etoile</div><div class="rules-power-desc">Vitesse +<br>immunite</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-banana.png" alt=""><div class="rules-power-name">Banane</div><div class="rules-power-desc">Pose un<br>piege</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-slow.png" alt=""><div class="rules-power-name">Eclair</div><div class="rules-power-desc">Ralentit<br>les autres</div></div><div class="rules-power-card"><img class="rules-power-asset" src="/elements/power-up-shield.png" alt=""><div class="rules-power-name">Bouclier</div><div class="rules-power-desc">Bloque<br>un coup</div></div></div></div></div>`,
      },
