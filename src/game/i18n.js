...
const TRANSLATIONS = {
  en: {
    ...
    lobby: {
      ...
      help: {
        title: 'How To Play',
        hint: 'The rules are simple.',
        bodyHTML: '<b>The goal</b><br>Be the first racer to cross the finish line. Everyone else drinks.<br><br><b>How it works</b><br>Pick your racers. Choose up to 6 champions. Set up the race. Pick a scene, length and power-ups. Watch the chaos. Cheer your crew to victory.',
      },
      rules: {
        title: 'Rules',
        hint: 'Know the game.',
        bodyHTML: 'Pick a racer, choose a colour, name them - then cheer them to the finish.<br><br><b>Winner</b> hands out sips equal to the number of players. Everyone else drinks their finishing place; <b>last place</b> gets one extra.<br><br><b>Slowpoke clause:</b> never led the race -> +1 sip of shame.',
      },
  ...
  fr: {
    ...
    lobby: {
      ...
      help: {
        title: 'Comment jouer',
        hint: 'Les regles sont simples.',
        bodyHTML: "<b>L'objectif</b><br>Faites franchir la ligne d'arrivee en premier a votre coureur. Tous les autres boivent.<br><br><b>Comment ca marche</b><br>Choisissez vos coureurs. Prenez jusqu'a 6 champions. Reglez la course. Choisissez une scene, une longueur et les power-ups. Regardez le chaos. Encouragez votre equipe jusqu'a la victoire.",
      },
      rules: {
        title: 'Regles',
        hint: 'Connaitre le jeu.',
        bodyHTML: "Choisissez un coureur, une couleur, donnez-lui un nom - puis encouragez-le jusqu'a l'arrivee.<br><br><b>Le gagnant</b> distribue autant de gorgees qu'il y a de joueurs. Tous les autres boivent leur place d'arrivee ; la <b>derniere place</b> prend une gorgee en plus.<br><br><b>Clause de la tortue :</b> n'a jamais mene la course -> +1 gorgee de honte.",
      },
